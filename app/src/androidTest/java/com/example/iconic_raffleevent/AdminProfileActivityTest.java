...
public class AdminProfileActivityTest {
    ...
    @Before
    public void setUp() {
        Intent intent = new Intent(ApplicationProvider.getApplicationContext(), AdminProfileActivity.class);
    ...
    @Test
    public void testProfileListClick() {
    ...
    @Test
    public void testDeleteProfileDialogButtons() {
        // Simulate a click on the first item in the list
        onData(Matchers.anything())
                .inAdapterView(withId(R.id.profile_list_view))
                .atPosition(0)
